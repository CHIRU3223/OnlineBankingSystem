...
namespace OnlineBankingSystem.Migrations
{
    ...
    [Migration("20220905061609_AddingRequestsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineBankingSystem.Models.Request", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ReqAccountNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("OnlineBankingSystem.Models.Request", b =>
                {
                    b.HasOne("OnlineBankingSystem.Models.User", "ReqUser")
                        .WithMany()
                        .HasForeignKey("Username");
